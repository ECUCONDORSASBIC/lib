...
function GET(request) {
  var authHeader, _ref, searchParams, patientId, calls;
  ...
  return regeneratorRuntime.async(function GET$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.next = 10;
          return regeneratorRuntime.awrap((0, _videoCallAndDocumentService.getVideoCalls)(patientId));
        ...
        case 14:
          ...
          return _context.abrupt("return", _server.NextResponse.json({
            success: false,
            message: 'Error al obtener historial de videollamadas.',
...
function POST(request) {
  var authHeader, _ref2, searchParams, patientId, callData;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          _context2.next = 13;
          return regeneratorRuntime.awrap(saveVideoCall(patientId, callData));

        case 13:
          return _context2.abrupt("return", _server.NextResponse.json({
            success: true,
            message: 'Videollamada guardada.'
          }));
        ...
        case 16:
          ...
          return _context2.abrupt("return", _server.NextResponse.json({
            success: false,
            message: 'Error al guardar videollamada.',
